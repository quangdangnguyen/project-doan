				...
				<div class="row">
					<div class="col-sm-12">
						<div class="beta-products-list">
							<h4 style="color: blue">Sản phẩm mới</h4>
							<div class="beta-products-details">
								<p class="pull-left">Tìm thấy <span style="color: red">{{count($new_product)}}</span> sản phẩm</p>
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$new->id)}}"><img src="{{$new->image}}" alt="" height="250px"></a>
										</div>
						...
						<div class="beta-products-list">
							<h4 style="color: blue">Sản phẩm khuyến mãi</h4>
							<div class="beta-products-details">
								<p class="pull-left">Tìm thấy <span style="color: red">{{count($sanpham_khuyenmai)}}</span> sản phẩm</p>
								<div class="clearfix"></div>
							</div>
							<div class="row">
							@foreach($sanpham_khuyenmai as $spkm)
								<div class="col-sm-3">
									<div class="single-item">
											<div class="ribbon-wrapper"><div class="ribbon sale">Sale</div></div>
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$spkm->id)}}"><img src="{{$spkm->image}}" alt="" height="250px"></a>
										</div>
										<div class="single-item-body">
